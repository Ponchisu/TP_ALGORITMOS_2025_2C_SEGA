...
> Libreria de SDL para el manejo de imagenes
  1. Buscar en el [repositorio de SDL_image](https://github.com/libsdl-org/SDL_image/releases?page=1) la version `2.8.8`.
  2. Descargar `SDL2_image-devel-2.8.8-mingw.zip`.
  3. Descomprimir el .zip.
